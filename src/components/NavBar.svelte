...
<nav class="none sm:flex flex-row justify-center items-center fixed w-screen h-16 px-11 bg-black ">
    <ul class="w-full max-w-[70rem] h-fit flex flex-row justify-left align-middle gap-4 ">
        <li class="font-mono font-semibold text-white hover:underline hover:cursor-pointer hover:underline-offset-4">@acmahaja</li>
